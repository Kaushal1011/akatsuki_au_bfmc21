            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        ...
                        html.H2(id='ptype', children="Lane Keep / CS")
                    ], style={'textAlign': 'center'})
                ]),
            ]),
            dbc.Col([
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        ...
                        html.H2(id='roadblock-detect', children="False")
                    ], style={'textAlign': 'center'})
                ]),
            ])
        ], className='mb-4'),
...
@app.callback(Output('stored_df', 'clear_data'),
            [Input('mem_clear', 'n_intervals')])
def clear_dcc_store(n_intervals):
        return True


if __name__ == '__main__':
    dff = pd.DataFrame(columns=['x', 'y', 'yaw', 'v', 'rear_x', 'rear_y', 'target_x', 'target_y'])
