...
def check_priority(img: np.ndarray, area_threshold: Tuple[int, int]):
...
# TODO: create class to prevent re initializing
...
if __name__ == "__main__":
    ...
    frame = frame[
        0 : np.int32(frame.shape[0] / 2),
        np.int32(frame.shape[1] / 2) : np.int32(frame.shape[1]),
    ]
    while True:
